...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/tango/32x32/actions/list-add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuConnect_to.setIcon(icon1)
        self.menuConnect_to.setObjectName("menuConnect_to")
        self.RemoveAccountMenu = QtGui.QMenu(self.menuAccounts)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/tango/32x32/actions/list-remove.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.RemoveAccountMenu.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/services/Twitter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.NewTwitterAccountAction.setIcon(icon3)
        self.NewTwitterAccountAction.setObjectName("NewTwitterAccountAction")
        self.QuitAction = QtGui.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/tango/32x32/actions/system-log-out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/tango/32x32/apps/help-browser.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.HelpAction.setIcon(icon5)
